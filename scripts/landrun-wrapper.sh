...
# Landrun's CLI needs an explicit delimiter before the sandboxed command.
# Comparator supplies Landrun options followed by lean4export's command; this
# wrapper preserves that boundary and refuses options that disable isolation.
