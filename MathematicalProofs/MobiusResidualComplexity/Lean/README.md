...
the pair decomposition, balance of a zero-sum unit cell, the contradiction in
the strict exponent sandwich, the square-root constant identity, and the
...
family asymptotic, the logarithmic scale conversion, the gcd/residual matching
model, rank-pair compression, or the global sparse-jump counting argument.
Those remain manuscript-level proofs.
